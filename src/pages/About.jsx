  ...
  return (
    <section className='max-container'>
      ...
      <div className='mt-5 flex flex-col gap-3 text-slate-500 text-xl'>
        <p>
          <b>-</b> I'm a student studying <b>Computer Science</b>, <b>Mathematics</b>, and <b>Economics</b> at <b>The University of Texas at Austin</b>, and am 
          a part of UT Austin's <b>Integrated 5-Year CS BS/MS Program</b>.
        </p>
        <p>
      ...
      <div className='py-16'>
        ...
        <div className='mt-5 flex flex-col gap-3 text-slate-500 text-xl'>
          <p>
            I've worked with all sorts of companies, from FAANG companies to local startups. Here's a few of them:
          </p>
        </div>
